...
const mockBikes = [
    { id: 1, name: 'Mountain Explorer X1', type: 'MOUNTAIN', status: 'AVAILABLE', pricePerHour: 20, pricePerKm: 2.0, imageUrl: 'https://images.unsplash.com/photo-1444491741275-3747c53c99b4?auto=format&fit=crop&q=80&w=800', description: 'Rugged and reliable for off-road campus trails.', location: { lat: 20.0494, lng: 99.8930, zone: 'North Gate' } },
